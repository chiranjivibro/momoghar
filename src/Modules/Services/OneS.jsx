...
function OneS() {
    return(
        <>
         <div className="w-[100%] m-auto px-4 pt-[115px]  sm:px-4 sm:pt-[115px] md:px-14 md:pt-[115px] lg:pt-[137px]  flex flex-col sm:flex-col md:flex-row justify-between align-middle pb-7 sm:pb-7 md:pb-14">
